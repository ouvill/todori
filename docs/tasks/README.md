...
| task-34 | 未着手 | [task-34-typography-rollout.md](./task-34-typography-rollout.md) | typography rollout。2026-07-06タイポ裁定（Newsreader範囲制限＋システム和文セリフ、Lora退役）を本番へ反映する | task-30・task-33の成果物と`docs/design/ui-spec.md`裁定済み事項に依存。M3 polish follow-up |
