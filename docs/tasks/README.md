...
| task-70 | 未着手 | [task-70-sync-server.md](./task-70-sync-server.md) | P2-M2 同期サーバー。Postgres/sqlx schema、OPAQUE登録/ログイン、セッション、push/pull、tenant_seq採番、§6.6不変条件、testcontainers Postgres統合テストを実装する | task-01・task-69の成果物、`docs/08_Phase2計画書.md` P2-M2、`docs/03_技術仕様書.md` §1.5・§2・§3・§6、ADR-003/005/008に依存 |
