...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 30675019;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__create_draft_task_impl(port, ptr, rust_vec_len, data_len),
        ...
        4 => wire__crate__api__get_latest_task_undo_impl(port, ptr, rust_vec_len, data_len),
        5 => wire__crate__api__get_lists_impl(port, ptr, rust_vec_len, data_len),
        6 => wire__crate__api__get_tasks_impl(port, ptr, rust_vec_len, data_len),
        7 => wire__crate__api__get_trashed_tasks_impl(port, ptr, rust_vec_len, data_len),
        8 => wire__crate__api__greet_impl(port, ptr, rust_vec_len, data_len),
        9 => wire__crate__api__init_core_impl(port, ptr, rust_vec_len, data_len),
        10 => wire__crate__api__rename_list_impl(port, ptr, rust_vec_len, data_len),
        11 => wire__crate__api__reorder_task_impl(port, ptr, rust_vec_len, data_len),
        12 => wire__crate__api__restore_task_impl(port, ptr, rust_vec_len, data_len),
        13 => wire__crate__api__set_task_status_impl(port, ptr, rust_vec_len, data_len),
        14 => wire__crate__api__trash_task_impl(port, ptr, rust_vec_len, data_len),
        15 => wire__crate__api__undo_task_operation_impl(port, ptr, rust_vec_len, data_len),
        16 => wire__crate__api__update_task_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
