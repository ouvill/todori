...
> ステータス: 完了（日付表示をロケール準拠skeleton APIへ統一）
> 作業日: 2026-07-08
...
- 作業日: 2026-07-08
- 結果: 固定日付パターンをロケール準拠のskeleton APIへ置換し、Home見出しをen/jaで検証した。相対日付表記は維持した。
- 証拠: widget testとvisual QA testを追加。commit `b5a6a9251acb0cfc6acfea489d3c42d25745515d`。
- 未解決: なし。
