...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1477083965;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        6 => wire__crate__api__confirm_organization_safety_number_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        7 => wire__crate__api__count_task_descendants_impl(port, ptr, rust_vec_len, data_len),
        8 => wire__crate__api__count_tasks_in_list_impl(port, ptr, rust_vec_len, data_len),
        9 => wire__crate__api__create_draft_task_impl(port, ptr, rust_vec_len, data_len),
        10 => wire__crate__api__create_list_impl(port, ptr, rust_vec_len, data_len),
        11 => wire__crate__api__create_task_impl(port, ptr, rust_vec_len, data_len),
        12 => wire__crate__api__delete_list_impl(port, ptr, rust_vec_len, data_len),
        13 => wire__crate__api__delete_task_impl(port, ptr, rust_vec_len, data_len),
        14 => {
            wire__crate__api__discard_active_timer_session_impl(port, ptr, rust_vec_len, data_len)
        }
        15 => wire__crate__api__finish_active_timer_session_impl(port, ptr, rust_vec_len, data_len),
        16 => wire__crate__api__get_account_session_state_impl(port, ptr, rust_vec_len, data_len),
        17 => wire__crate__api__get_active_timer_session_impl(port, ptr, rust_vec_len, data_len),
        18 => wire__crate__api__get_archived_lists_impl(port, ptr, rust_vec_len, data_len),
        19 => wire__crate__api__get_calendar_occurrences_impl(port, ptr, rust_vec_len, data_len),
        20 => {
            wire__crate__api__get_completed_timer_sessions_impl(port, ptr, rust_vec_len, data_len)
        }
        21 => wire__crate__api__get_home_tasks_impl(port, ptr, rust_vec_len, data_len),
        22 => wire__crate__api__get_latest_task_undo_impl(port, ptr, rust_vec_len, data_len),
        23 => wire__crate__api__get_list_reminders_impl(port, ptr, rust_vec_len, data_len),
        24 => wire__crate__api__get_lists_impl(port, ptr, rust_vec_len, data_len),
        25 => wire__crate__api__get_local_time_zone_impl(port, ptr, rust_vec_len, data_len),
        26 => wire__crate__api__get_realtime_ticket_impl(port, ptr, rust_vec_len, data_len),
        27 => wire__crate__api__get_setting_impl(port, ptr, rust_vec_len, data_len),
        28 => wire__crate__api__get_sync_server_url_impl(port, ptr, rust_vec_len, data_len),
        29 => wire__crate__api__get_sync_status_impl(port, ptr, rust_vec_len, data_len),
        30 => wire__crate__api__get_task_reminders_impl(port, ptr, rust_vec_len, data_len),
        31 => wire__crate__api__get_task_subtree_reminders_impl(port, ptr, rust_vec_len, data_len),
        32 => wire__crate__api__get_tasks_impl(port, ptr, rust_vec_len, data_len),
        33 => wire__crate__api__greet_impl(port, ptr, rust_vec_len, data_len),
        34 => wire__crate__api__init_core_impl(port, ptr, rust_vec_len, data_len),
        35 => wire__crate__api__list_pending_reminders_impl(port, ptr, rust_vec_len, data_len),
        36 => wire__crate__api__organization_safety_number_impl(port, ptr, rust_vec_len, data_len),
        37 => wire__crate__api__pomodoro_target_reached_at_impl(port, ptr, rust_vec_len, data_len),
        38 => wire__crate__api__rename_list_impl(port, ptr, rust_vec_len, data_len),
        39 => wire__crate__api__reorder_task_impl(port, ptr, rust_vec_len, data_len),
        40 => wire__crate__api__rotate_device_key_impl(port, ptr, rust_vec_len, data_len),
        41 => wire__crate__api__search_tasks_impl(port, ptr, rust_vec_len, data_len),
        42 => wire__crate__api__set_setting_impl(port, ptr, rust_vec_len, data_len),
        43 => wire__crate__api__set_sync_server_url_impl(port, ptr, rust_vec_len, data_len),
        44 => wire__crate__api__set_task_reminder_impl(port, ptr, rust_vec_len, data_len),
        45 => wire__crate__api__set_task_status_impl(port, ptr, rust_vec_len, data_len),
        46 => wire__crate__api__snooze_reminder_impl(port, ptr, rust_vec_len, data_len),
        47 => wire__crate__api__start_active_timer_session_impl(port, ptr, rust_vec_len, data_len),
        48 => wire__crate__api__sync_now_impl(port, ptr, rust_vec_len, data_len),
        49 => wire__crate__api__unarchive_list_impl(port, ptr, rust_vec_len, data_len),
        50 => wire__crate__api__undo_task_operation_impl(port, ptr, rust_vec_len, data_len),
        51 => wire__crate__api__update_active_timer_session_impl(port, ptr, rust_vec_len, data_len),
        52 => wire__crate__api__update_task_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
