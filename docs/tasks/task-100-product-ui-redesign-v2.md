...
- Design Labのtask完了を、90msのpress、250ms check fill / path、360msの単一halo、300msの左から右へ進むstrikethroughへ引き上げた。完了taskは800msだけ通常位置に留まって操作の結果を見せた後、fadeしながら4px上へ抜けてCompletedへ移る。Reduce Motionでは装飾motionを省略して即時確定する。
