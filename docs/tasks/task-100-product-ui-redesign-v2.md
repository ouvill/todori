...
- 生成物: `app/build/visual_qa/design_lab_task_list.png`、`app/build/visual_qa/design_lab_task_detail.png`、`app/build/visual_qa/design_lab_focus_timer.png`。3画面を目視し、overflow、glyph欠落、navigationの混入がないことを確認した。
...
- `cd app && flutter test --concurrency=1`: 131件成功、visual QA harness 1件は設計どおりskip。
