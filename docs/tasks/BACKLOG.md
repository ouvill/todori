...
| # | タスク | 内容 | 対応マイルストーン | 備考 |
|---|---|---|---|---|
| 1 | task-60: チェック完了モーション受け入れFBの精度改善 | チェック円/48pxヒット領域/Ink波紋を同心化し、取り消し線アニメ終了フレームと静止状態を一致させ、Home単独表示行は完了モーション後に退場/再構成する | 軽量レーン | 出典: 2026-07-08モーション体感受け入れFB。task-59完了状態に依存 |
