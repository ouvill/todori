...
| task-59 | 未着手 | [task-59-check-completion-motion.md](./task-59-check-completion-motion.md) | チェック完了モーション。チェック線path描画、左から右へ伸びる取り消し線、チェック起点の局所パーティクル、Reduce Motion分岐を実装する | task-56の完了状態に依存。出典: 2026-07-08人間裁定（チェック完了モーション） |
