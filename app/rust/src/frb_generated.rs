...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 360116510;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        38 => wire__crate__api__rotate_device_key_impl(port, ptr, rust_vec_len, data_len),
        39 => wire__crate__api__search_tasks_impl(port, ptr, rust_vec_len, data_len),
        40 => wire__crate__api__set_setting_impl(port, ptr, rust_vec_len, data_len),
        41 => wire__crate__api__set_sync_server_url_impl(port, ptr, rust_vec_len, data_len),
        42 => wire__crate__api__set_task_reminder_impl(port, ptr, rust_vec_len, data_len),
        43 => wire__crate__api__set_task_status_impl(port, ptr, rust_vec_len, data_len),
        44 => wire__crate__api__snooze_reminder_impl(port, ptr, rust_vec_len, data_len),
        45 => wire__crate__api__start_active_timer_session_impl(port, ptr, rust_vec_len, data_len),
        46 => wire__crate__api__sync_now_impl(port, ptr, rust_vec_len, data_len),
        47 => wire__crate__api__unarchive_list_impl(port, ptr, rust_vec_len, data_len),
        48 => wire__crate__api__undo_task_operation_impl(port, ptr, rust_vec_len, data_len),
        49 => wire__crate__api__update_active_timer_session_impl(port, ptr, rust_vec_len, data_len),
        50 => wire__crate__api__update_task_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
